#'gauss.norm
#'
#' It performs a Gaussian normalization based on \code{\link[flowStats]{gaussNorm()}} function.
...
#' @param marker.to.norm Marker name(s) to normalize (based on visual inspection with \code{\link[FlowCT]{multidensity()}}).
