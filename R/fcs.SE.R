#' fcs.SE
#'
#' It reads and creates a FCS.SE object (based on the structure of a (\ref{https://www.bioconductor.org/packages/release/bioc/html/SummarizedExperiment.html}{\code{SummarizedExperiment}}) from FCS files in a specific folder or indicated in a vector.
...
#' fcs_se <- fcs.SE(directory = "../data/", which.lines = 1000, metadata = metadata_user, transf.cofactor = 500)
#' }
