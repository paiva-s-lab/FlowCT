...
#' @param clusters.named Column name from the \code{colData(fcs.SCE)} object which contains renamed clusters (through \code{\link[FlowCT:clusters.rename]{clusters.rename()}}).
